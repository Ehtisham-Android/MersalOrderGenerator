...
public class PlayServicesHelper {
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (googleAPI.isUserResolvableError(resultCode)) {
                googleAPI.getErrorDialog(activity, resultCode, PLAY_SERVICES_RESOLUTION_REQUEST)
                        .show();
            } else {
    ...
    private String getRegistrationId() {
        ...
        int currentVersion = getAppVersion();//objAPP.getAppVersion(); //App.getInstance().getAppVersion();
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    regId = googleCloudMessaging.register(GlobalClass.PROJECT_NUMBER);
...
//    }
    ...
    private void storeRegistrationId(String regId) {
        ...
        //if(App.getInstance() != null){
            appVersion = getAppVersion();//App.getInstance().getAppVersion();
            Log.i(TAG, "Saving regId on app version inside" + appVersion);
        //}
